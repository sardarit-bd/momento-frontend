...
const ProductCustomizer = () => {
  ...
  console.log("this is product: ", product?.customizations?.custom_sets);
  ...
  const goToFinalView = async ({ redirectToCheckout = false } = {}) => {
    ...
    setspinloading(false);
    router.push(
      redirectToCheckout ? "/my-cart/checkout" : "/final/customization",
    );
  };
  ...
  const doneButtonLabel =
    doneloading || spinloading ? "Loading..." : "Next Card";
