      ...
      {sidebarTab === "front" && (
        <div className="rounded-2xl border border-slate-200 bg-linear-to-b from-slate-50 to-white p-2.5 shadow-sm">
          ...
          <p className="text-xs text-slate-500 mb-1.5">
            Pick a premium frame style for the front of your trading card.
          </p>
            ...
            {filteredTemplates.map(([key, tpl]) => {
              ...
              return (
                <button
                  key={key}
                  onClick={() => {
                    setBaseFront(tpl.image);
                    setcardfinder(tpl.cardfinder);
                  }}
      ...
      {sidebarTab === "front" && (
        <div className="my-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="mb-3 flex items-center justify-between">
            ...
            <span className="text-gray-600 bg-amber-100 px-2 py-1 rounded-md text-xs font-medium">
              Recommended: 250 x 334 px
            </span>
          </div>
          <label
            htmlFor="uploadImage"
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              <div className="text-xs text-slate-500">
                PNG, JPG or WEBP. After upload, drag and resize it on the card
                preview.
              </div>
            </div>
          ...
          {activeImage && (
            <div className="mt-2 text-xs text-emerald-700 font-medium">
              Image selected. You can drag and resize directly on canvas.
            </div>
          )}
            ...
            <div className="mt-3">
              <div className="mb-1 flex items-center justify-between">
                ...
                <span className="text-xs font-semibold text-slate-600">
                  {Math.round(
                    (uploads.find((u) => u.id === activeImage)?.scale ?? 1) *
                      100,
                  )}
                  %
                </span>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (activeImg)
                    updateUploadScale(activeImg.id, parseFloat(e.target.value));
                }}
      ...
      {sidebarTab === "back" && (
        <div className="rounded-2xl border border-slate-200 bg-linear-to-b from-slate-50 to-white p-4 shadow-sm">
          ...
          <p className="text-xs text-slate-500 mb-3">
            Choose the back design. Preview shows full card proportion.
          </p>
              ...
              {backHighlights.map((item) => (
                <div key={item.id} className="relative flex items-center gap-2">
                  <button
                    type="button"
                    onClick={() =>
                      setActiveBackHighlightPicker((prev) =>
                  ...
                  <input
                    value={item.text}
                    onChange={(e) =>
                      updateBackHighlightText(item.id, e.target.value)
                    }
                      ...
                      <div className="grid grid-cols-8 gap-2">
                        {attributeIconOptions.map((icon) => (
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              updateBackHighlightIcon(item.id, icon)
                            }
          ...
          <div className="border border-gray-200 p-4 md:p-5 mb-4 rounded-xl bg-white shadow-sm ring-1 ring-gray-100">
            ...
            <div className="w-full flex flex-col">
              <label className="text-gray-500 mb-1 text-sm flex items-center justify-between">
                <span>
                  Card Date/Tag: <span className="text-red-600 text-xl">*</span>
                </span>
                <CharactersCountComponent
                  text={acarddate}
                  limit={acarddatelimite}
                />
              </label>
              <input
                value={acarddate}
