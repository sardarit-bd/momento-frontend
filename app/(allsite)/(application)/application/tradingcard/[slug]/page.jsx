        ...
        >
          ...
          <MobileTabStrip
            ...
            onTabClick={(tab) => {
              setMobileDrawer(tab);
              if (tab === "front") {
                state.setSidebarTab("front");
                state.setworkingcard("front");
              }
              if (tab === "attributes") state.setSidebarTab("attributes");
              if (tab === "back") {
                state.setSidebarTab("back");
                state.setworkingcard("back");
              }
            }}
          />
        </div>
            ...
            <div style={{ flex: 1, minHeight: 0, overflow: "hidden" }}>
              <TradingCardControls
                ...
                setActiveBackHighlightPicker={
                  state.setActiveBackHighlightPicker
                }
                backLegacyTagline={state.backLegacyTagline}
                setBackLegacyTagline={state.setBackLegacyTagline}
                backLegacyText={state.backLegacyText}
      ...
      >
        ...
        {Array.from({
          ...
          >
            ...
            <span style={{ fontSize: 10, color: "#d1d5db", marginTop: 2 }}>
              Empty
            </span>
          </div>
        ))}
