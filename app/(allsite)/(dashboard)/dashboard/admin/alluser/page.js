...
const AllUser = () => {
    ...
    const handleRoleChange = async (userId, newRole) => {
        ...
        const response = await MakePut(`api/users/${userId}/role`, { role: newRole }, token);
                                                ...
                                                <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
                                                    ...
                                                    <td className="py-3 px-6">
                                                        {isEditing ? (
                                                            ...
                                                            <span
                                                                onClick={() => handleRoleClick(item?.id, currentRole)}
                                                                className={`inline-block px-3 py-1 rounded-full text-xs font-semibold cursor-pointer ${currentRole === 'Admin'
