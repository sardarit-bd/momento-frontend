  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-xs font-semibold text-sky-700 bg-linear-to-r from-sky-50 to-cyan-50 border border-sky-100 px-3 py-1 rounded-full">
      ...
      {fetchloading ? (
          ...
          {data.categories.map((cat, idx) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`w-10 h-10 rounded-xl bg-linear-to-br ${palette.bg} ring-1 ring-transparent ${palette.ring} flex items-center justify-center mb-3 transition-all duration-300`}
                >
        ...
        <div className="flex flex-col items-center justify-center py-16 bg-linear-to-b from-white to-gray-50/50 rounded-2xl border border-dashed border-gray-200">
          <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-sky-50 to-sky-100 flex items-center justify-center mb-4">
