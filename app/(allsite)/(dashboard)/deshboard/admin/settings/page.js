...
import { FiEdit2, FiEye, FiEyeOff, FiCreditCard, FiLock, FiX } from "react-icons/fi";
...
export default function SiteSettings() {
    ...
    const inputClass = (field) => `w-full pl-4 pr-11 py-3 rounded-xl text-sm text-gray-800 placeholder:text-gray-400 outline-none transition-all duration-200 ${
        !isedit
        ...
        <div className="w-full">
            ...
            <div className="flex items-center justify-between mb-7">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 leading-tight tracking-tight">Site Settings</h1>
                        <p className="text-gray-500 text-sm">Manage your Stripe payment credentials</p>
                    </div>
                </div>
                ...
                {!fetchloading && (
                    isedit ? (
                        <button
                            onClick={() => { setisedit(false); fetching(token); }}
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-sky-500 to-sky-600 text-white text-sm font-semibold rounded-xl hover:from-sky-600 hover:to-sky-700 active:scale-[0.97] transition-all duration-200 shadow-lg shadow-sky-200"
                        >
            ...
            {fetchloading ? (
                ...
                <form onSubmit={handleSubmit} className="relative bg-white rounded-2xl border border-gray-100 shadow-[0_2px_20px_-4px_rgba(0,0,0,0.06)] p-6 overflow-hidden">
                    ...
                    <div className="flex items-center gap-2 mb-1 pb-4 border-b border-gray-100">
                        ...
                        <h2 className="text-base font-semibold text-gray-800">Stripe Credentials</h2>
                    </div>
                    <p className="text-xs text-gray-400 mb-5 pt-3">
                        These keys connect your app to Stripe for processing payments. Keep your secret and webhook keys private.
                    </p>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    tabIndex={-1}
                                >
                                    {showWebhook ? <FiEyeOff className="text-base" /> : <FiEye className="text-base" />}
                                </button>
                            </div>
                        </div>
                    </div>
