...
export default function ProfilePage() {
    ...
    const inputClass = (field, locked = false) => `w-full px-4 py-3 rounded-xl text-sm outline-none transition-all duration-200 ${
        locked
        ...
        <div className="w-full">
            ...
            <div className="flex items-center justify-between mb-7">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 leading-tight tracking-tight">Profile Information</h1>
                        <p className="text-gray-500 text-sm">Manage your personal account details</p>
                    </div>
                </div>
                ...
                {!fetchloading && (
                    isedit ? (
                        <button
                            onClick={() => { setisedit(false); fetching(id, token); }}
            ...
            {fetchloading ? (
                ...
                <div className="relative bg-white rounded-2xl border border-gray-100 shadow-[0_2px_20px_-4px_rgba(0,0,0,0.06)] p-6 overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-sky-100 to-sky-50 border border-sky-100 flex items-center justify-center shrink-0">
                            <span className="text-lg font-bold text-sky-600">{initials}</span>
                        </div>
                        <div className="min-w-0">
                            <h2 className="text-base font-semibold text-gray-900 truncate">{name || 'Unnamed User'}</h2>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="space-y-5">
                            ...
                            {/* Phone - kept hidden as in original */}
                            ...
                            {/* Address - kept hidden as in original */}
                            <div className="hidden">
                                <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">
                                    Address
                                </label>
