      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          <button
            ...
            className="border border-gray-200 bg-sky-400 text-white p-2 rounded-md shadow-md cursor-pointer hover:bg-sky-500 transition duration-100 flex items-center gap-2"
          >
