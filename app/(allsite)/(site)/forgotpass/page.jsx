...
const ForgotPas = () => {
  ...
  async function OTPsend(e) {
    ...
    if (email) {
      setLoading(true);
      const response = await logingandsignupmakepost("api/forgotpass", {
        email,
      });
  ...
  async function verifyOTP(e) {
    ...
    if (otp) {
      setLoading(true);
      const response = await logingandsignupmakepost("api/verify", {
        email,
        otp,
      });
  ...
  async function passwordChange(e) {
    ...
    if (password && conpass) {
      if (password === conpass) {
        ...
        const response = await logingandsignupmakepost(
          "api/resetpass",
          passdata,
        );
