        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 space-y-6 text-center md:text-left">
              ...
              <p className="text-lg text-gray-700/70 leading-relaxed">
                Design custom cards inspired by friends, family, or favorite
                characters — choosing their look, vibe, and personality. We
                professionally print and ship everything straight to your door.
              </p>
              ...
              <Link
                href={"/shop"}
                className="bg-sky-400 hover:bg-sky-400/80 text-primary-foreground px-6 py-4 text-lg rounded-full"
              >
