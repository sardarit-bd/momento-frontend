...
const CardSidebar = ({
  ...
  return (
    <div className="w-full bg-white h-full shawow-md px-0 py-2 z-20 flex flex-col">
      ...
      <div className="w-full lg:w-full flex flex-row lg:flex-col gap-4 items-center h-20 pl-0 pr-0 py-1 lg:h-full lg:flex-1 lg:min-h-0 snap-mandatory overflow-x-scroll cursor-grab lg:overflow-y-scroll scrollbar-hide">
        {cards?.map((finalCard, idx) => (
          <div
            ...
            key={idx}
            className="w-15 h-full lg:h-fit lg:w-full relative flex items-cemter justify-center z-0 snap-start"
          >
            <CardThumbnail finalCard={finalCard} />
        ...
        {cards?.length < 5 && (
          <div className="w-15 h-full lg:h-45 lg:w-full relative flex items-cemter justify-center z-0 snap-start items-center ">
