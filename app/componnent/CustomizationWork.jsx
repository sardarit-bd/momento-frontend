...
const steps = [
  ...
  },
  {
    id: 4,
    title: "Print & Deliver",
    description: "Sharp details, vibrant colors, and premium card texture.",
    image: quality,
  },
];
...
export default function CustomizationWork() {
  return (
    <section className="text-center py-20 container mx-auto">
          ...
          return (
            ...
            >
              ...
              <h2 className="text-2xl font-bold mb-2 uppercase">
                {firstPart} <span className="text-[#3CA9FF]">{lastWord}</span>
              </h2>
      ...
      <Link
        href={"/shop"}
        className="mt-12 inline-block bg-[#3CA9FF] text-white py-3 px-6 rounded-md 
