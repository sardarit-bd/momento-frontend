      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-12">
        <div className="flex-1">
          ...
          <div className="mt-8 space-y-4 text-lg text-gray-700">
            ...
            <div className="flex items-start gap-3">
              <FaCheckSquare className="text-sky-500 mt-1" />
              <p>Momento exists at that shift.</p>
            </div>

            <div className="flex items-start gap-3">
              <FaCheckSquare className="text-sky-500 mt-1" />
              <p>Early customers aren’t just buying a deck.</p>
            </div>

            <div className="flex items-start gap-3">
              <FaCheckSquare className="text-sky-500 mt-1" />
              <p>They’re stepping into something ahead of its time.</p>
            </div>
          </div>
          ...
          <div className="mt-8 flex gap-4">
            <Link
              href={"/shop"}
              className="px-6 py-3 bg-sky-500 text-white font-semibold rounded-md shadow-md hover:brightness-110 transition"
            >
              START CUSTOMIZING
            </Link>
          </div>
