    ...
    return (
        <header className="bg-white border border-b border-gray-200 h-[75px] w-full  fixed z-9000">
            <div className="flex items-center h-full w-full justify-center">
                <div className={`px-2 md:px-7 h-full w-full flex items-center justify-between ${!isApplication && !isDashboard && "max-w-7xl"}`}>
                    <Link href={'/'} className={`flex items-center h-full ${isDashboard && "pl-14 md:pl-10 lg:pl-0"}`}>
