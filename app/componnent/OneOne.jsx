        ...
        <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
          ...
          <div className="space-y-6">
            <p className="text-lg md:text-xl text-slate-600 leading-relaxed">
              For decades, games and collectibles have focused on fictional
              characters and cultural icons. Meanwhile, the moments that matter
              most in our own lives live inside camera rolls — rarely revisited,
              never collected.
            </p>
