...
const PhotoCardSidebar = ({ activeIndex, Done, setActiveIndex, addCard, removeCard, doneloading, cards, lockedCardType, onSelectCard }) => {
  ...
  return (
    <div className="w-full bg-white h-full shawow-md px-0 py-2 z-20 flex flex-col">
      ...
      <div className="w-full lg:w-full flex flex-row lg:flex-col gap-4 items-center h-[90px] px-3 py-1 lg:h-full lg:flex-1 lg:min-h-0 snap-mandatory overflow-x-scroll cursor-grab lg:overflow-y-scroll scrollbar-hide">
