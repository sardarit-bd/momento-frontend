    ...
    <div className="w-full max-w-3xl mx-auto">
                ...
                <img
                  ...
                  onTouchStart={(e) => {
                    ...
                    const handleUp = (endEvent) => {
                      ...
                      const endX = isTouchEnd
                        ? endEvent.changedTouches[0].clientX
                        : endEvent.clientX;
                      const endY = isTouchEnd
      ...
      {boxImages.length < MAX_IMAGES && (
        <div
          ...
          onDrop={onDrop}
          className={`flex h-50 cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed transition my-2 ${
            dragging
        ...
        >
          ...
          <p className="px-3 text-center text-sm font-medium text-gray-500">
            {busy
              ? "Reading image…"
              : `Add Photo (${boxImages.length}/${MAX_IMAGES})`}
          </p>
