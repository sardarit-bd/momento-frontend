  ...
  return (
    <div className={styles.prograssberWrp}>
      <div
        ...
        className={rander > 1 || rander === 1 ? styles.active : styles.alldiv}
      >
      ...
      <div
        ...
        className={rander > 2 || rander === 2 ? styles.active : styles.alldiv}
      >
        {rander > 2 ? <TiTick className={styles.icons} /> : 2}
      </div>
      <div
        className={rander > 3 || rander === 3 ? styles.active : styles.alldiv}
      >
