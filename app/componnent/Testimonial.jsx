  ...
  const testimonials = [
    {
      ...
      feedback:
        "An absolutely amazing experience! I was blown away by the quality, the attention to detail, and the beautiful design of the cards.",
      rating: 5,
    },
    {
      id: 2,
      ...
      feedback:
        "The customer service was fantastic from start to finish. Everything arrived on time and exceeded our expectations. Highly recommend!",
      rating: 5,
    },
    {
      id: 3,
      ...
      feedback:
        "These cards were stunning. Every single one of my clients loved them. They add such a professional touch to my deliveries.",
      rating: 5,
    },
    {
      id: 4,
      ...
      feedback:
        "High-quality prints, incredibly fast delivery, and a seamless ordering process. I will definitely be a returning customer.",
      rating: 5,
    },
  ];
