...
export const FrontOne = ({
  ...
  return (
    ...
    >
      <div className="absolute left-6.25 right-6.25 bottom-8.25 h-1/3 z-40 pointer-events-none rounded-bl-2xl rounded-br-2xl overflow-hidden">
        <div className="absolute left-0 top-0 bottom-0 w-full" />
      </div>

      <div
        className="absolute left-10 bottom-15 z-50 w-28 lg:w-33"
    ...
    >
      <div className="absolute left-6.25 right-6.25 bottom-8.25 h-1/3 z-40 pointer-events-none rounded-bl-2xl rounded-br-2xl overflow-hidden">
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(252,211,77,0) 0%, rgba(255, 117, 4, 0.34) 18%, rgba(234,88,12,0.62) 100%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(252,211,77,0) 0%, rgba(255, 117, 4, 0.34) 18%, rgba(234,88,12,0.58) 100%)",
          }}
        />
      </div>

      <div
        className="absolute left-6.25 bottom-8.25 z-50 w-30"
        style={{ backgroundColor: "transparent" }}
      >
        <AttributeLabel
          icon={iconOne}
          text={name.toUpperCase()}
          className="block text-white text-xs font-bold text-left"
        />
        <AttributeLabel
          icon={iconTwo}
          text={name2}
          className="block text-white text-xs font-bold text-left mt-1"
        />
        <AttributeLabel
          icon={iconThree}
          text={name3}
      ...
      <span className="absolute bottom-2 left-1/2 -translate-x-1/2 z-50 text-[8px] lg:text-[12px] text-[#1f1f1f] font-semibold tracking-wide text-center whitespace-nowrap">
        &copy; {currentYear} MOMENTO TRADING CARDS
      </span>
    </div>
  );
...
export const BackOne = ({
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "transparent" }}
    >
      <span className="TradingCardDateGrayGradient text-xl font-extrabold absolute top-10 left-8 text-center w-44 z-50 tracking-tighter">
        {(dateLabel || "Memory Card").toUpperCase()}
      </span>

      <span
        className={`${isblack ? "text-black" : "text-white"} text-xs AileronFont tracking-wider font-thin leading-[1.1] absolute top-22 left-15 text-center wrap-break-word w-67.5 z-50`}
        style={{
          display: "-webkit-box",
          WebkitLineClamp: 3,
      ...
      <span
        className={`${isblack ? "text-black" : "text-white"} text-md font-extrabold absolute top-44 left-37 text-left w-46.25 z-50 tracking-tighter`}
      >
      ...
      {safeHighlights.length > 0 ? (
        <div
          className={`${isblack ? "text-black" : "text-white"} AileronFont tracking-wider font-thin absolute top-57 left-15 w-67.5 z-50`}
        >
        ...
        <span
          className={`${isblack ? "text-black" : "text-white"} text-xs AileronFont tracking-wider font-thin absolute top-57 left-15 line-clamp-4 text-center w-67.5 z-50`}
        >
      ...
      <span
        className={`${isblack ? "text-black" : "text-white"} text-md font-extrabold absolute top-98.5 left-15 text-right w-44 z-50 tracking-tighter`}
      >
        {(legacyTagline || "Legacy Tagline").toUpperCase()}
      </span>

      <span
        className={`${isblack ? "text-black" : "text-white"} text-xs AileronFont tracking-wider font-thin absolute top-107 left-15 text-center w-67.5 z-50`}
        style={{
          display: "-webkit-box",
          WebkitLineClamp: 4,
          WebkitBoxOrient: "vertical",
