...
const Three = () => {
  ...
  const onConfirm = async (e) => {
    ...
    try {
      ...
      const flattenedBaseCards =
        layerBaseCard?.flatMap((group) =>
        ...
        <div className="col-span-1 md:col-span-3 space-y-4">
          ...
          <Section title="Product Info">
            {[
              ...
              {
                label: "Offer Price",
                value: productofferPrice ? `$${productofferPrice}` : "—",
              },
              {
                label: "Status",
                value: String(productStatus) === "true" ? "Published" : "Draft",
              },
              ...
              <>
                <Section title="Base Cards">
                  {layerBaseCard?.length > 0 ? (
                    <ImageGrid
                      images={layerBaseCard.flatMap((g) => g?.images ?? [])}
                      getKey={(i) => i.base64}
                    />
                  ) : (
