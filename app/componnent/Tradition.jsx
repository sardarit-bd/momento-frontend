    ...
    <section className="container mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 items-center gap-10">
      ...
      <div className="space-y-6 order-last md:order-frist">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          Create your own set of Momento Playing Deck Cards with fully
          customizable faces and themes. Perfect for game nights, gifts, or
          making every shuffle personal.
        </p>
        <p className="text-lg text-gray-600 leading-relaxed">
