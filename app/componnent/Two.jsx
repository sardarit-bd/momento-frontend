...
const CARD_SLOTS = {
    ...
    Jeck_Card:  ['Clubs_Face_Jack', 'Diamonds_Face_Jack', 'Hearts_Face_Jack', 'Spades_Face_Jack'],
    Queen_Card: ['Clubs_Face_Queen', 'Diamonds_Face_Queen', 'Hearts_Face_Queen', 'Spades_Face_Queen'],
    king_Card:  ['Clubs_Face_King', 'Diamonds_Face_King', 'Hearts_Face_King', 'Spades_Face_King'],
...
const Two = () => {
    ...
    const calculateDropdownPosition = (buttonEl, slotCount) => {
        ...
        const dropdownHeight = (slotCount * DROPDOWN_ITEM_HEIGHT) + DROPDOWN_HEADER_HEIGHT + 8;
    ...
    const renderCardSection = (cardType) => {
        ...
        const handlePlusClick = (e) => {
            ...
            if (isActive) { setActiveSlotSelector(null); return; }
            const pos = calculateDropdownPosition(e.currentTarget, availableSlots.length);
            setDropdownPos(pos);
        ...
        return (
            <div key={cardType} className="flex items-start gap-3">
                ...
                <div className="flex flex-wrap gap-2 items-start">
                    {/* Uploaded previews */}
                    {layerBaseCard?.filter(t => t?.card_type === cardType)?.map((t, idx) =>
                        t?.images?.map((imgObj, i) => (
                            <div key={`${idx}-${i}`} className="flex flex-col items-center">
                                <div className="relative w-[54px] h-[54px] border border-gray-200 rounded-md">
                                    ...
                                    />
                                    <div
                                        onClick={() => handleRemoveForcustomaizationBaseURl(i, layerBaseCard, setlayerBaseCard, cardType)}
                                ...
                                <span className="text-[9px] text-gray-500 mt-0.5 max-w-[54px] truncate text-center leading-tight">
                                    {imgObj.name ? imgObj.name.replace(/_/g, ' ') : imgObj.filename}
                                </span>
                            </div>
                        ))
                    )}
                    ...
                    {availableSlots.length > 0 && (
                        <div className="flex flex-col items-center gap-0.5">
                            ...
                            <span className="text-[9px] text-transparent leading-tight">spacer</span>
                        </div>
                    )}
                </div>
                ...
                <input
                    ...
                    onChange={(e) => {
                        ...
                        if (!slotName) { e.target.value = ""; return; }
    ...
    return (
        <div className="flex justify-center px-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
                    ...
                    <div className="space-y-5 col-span-1 md:col-span-8 border border-gray-300 rounded-md px-4 py-3">
                        ...
                        <div>
                            ...
                            <input type="number" value={productofferPrice} onChange={(e) => setproductofferPrice(e.target.value)}
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none" />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea value={productShortDescription} onChange={(e) => setproductShortDescription(e.target.value)}
                                rows="3" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea value={productDescription} onChange={(e) => setproductDescription(e.target.value)}
                                rows="5" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" />
                        </div>
                            ...
                            <>
                                ...
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">
                                        Base Card:&nbsp;
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white">{layerBaseCard?.length}</span>
                                        &nbsp;<span className="text-red-500 text-xl">*</span>&nbsp;
                                        <span className="text-xs text-gray-400">Select a slot, then pick an image</span>
                                    </label>
                                ...
                                {/* Skin Tone */}
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">Skin Tone:
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{layerSkinTone?.length}</span>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {layerSkinTone?.map((src, idx) => (
                                                <div key={idx} className="relative w-[54px] h-[54px] border-gray-200 rounded-md">
                                                    <Image src={src} alt={`skin-${idx}`} fill className="object-cover rounded-md" />
                                            ...
                                            <input onChange={(e) => handleFileChangeMultipul(e, setlayerSkinTone, layerSkinTone)} id="image_taker_skin_tone" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Hair */}
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">Hair:
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{layerHair?.length}</span>
                                        <span className="text-red-500 text-xl ml-1">*</span>
                                    </label>
                                    <div className="w-full min-h-[60px] max-h-[200px] bg-gray-100 rounded-md p-2 overflow-y-scroll no-scrollbar">
                                        <div className="flex flex-wrap gap-2">
                                            {layerHair?.map((src, idx) => (
                                                <div key={idx} className="relative w-[54px] h-[54px] border-gray-200 rounded-md">
                                                    <Image src={src} alt={`hair-${idx}`} fill className="object-cover rounded-md" />
                                            ...
                                            <input onChange={(e) => handleFileChangeMultipul(e, setlayerHair, layerHair)} id="image_taker_Hair" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Nose */}
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">Nose:
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{layerNose?.length}</span>
                                        <span className="text-red-500 text-xl ml-1">*</span>
                                    </label>
                                    <div className="w-full min-h-[60px] max-h-[200px] bg-gray-100 rounded-md p-2 overflow-y-scroll no-scrollbar">
                                        <div className="flex flex-wrap gap-2">
                                            {layerNose?.map((src, idx) => (
                                                <div key={idx} className="relative w-[54px] h-[54px] border-gray-200 rounded-md">
                                                    <Image src={src} alt={`nose-${idx}`} fill className="object-cover rounded-md" />
                                            ...
                                            <input onChange={(e) => handleFileChangeMultipul(e, setlayerNose, layerNose)} id="image_taker_nose_card" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Eyes */}
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">Eyes:
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{layerEyes?.length}</span>
                                        <span className="text-red-500 text-xl ml-1">*</span>
                                    </label>
                                    <div className="w-full min-h-[60px] max-h-[200px] bg-gray-100 rounded-md p-2 overflow-y-scroll no-scrollbar">
                                        <div className="flex flex-wrap gap-2">
                                            {layerEyes?.map((src, idx) => (
                                                <div key={idx} className="relative w-[54px] h-[54px] border-gray-200 rounded-md">
                                                    <Image src={src} alt={`eyes-${idx}`} fill className="object-cover rounded-md" />
                                            ...
                                            <input onChange={(e) => handleFileChangeMultipul(e, setlayerEyes, layerEyes)} id="image_taker_Eyes_card" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Mouth */}
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">Mouth:
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{layerMouth?.length}</span>
                                        <span className="text-red-500 text-xl ml-1">*</span>
                                    </label>
                                    <div className="w-full min-h-[60px] max-h-[200px] bg-gray-100 rounded-md p-2 overflow-y-scroll no-scrollbar">
                                        <div className="flex flex-wrap gap-2">
                                            {layerMouth?.map((src, idx) => (
                                                <div key={idx} className="relative w-[54px] h-[54px] border-gray-200 rounded-md">
                                                    <Image src={src} alt={`mouth-${idx}`} fill className="object-cover rounded-md" />
                                            ...
                                            <input onChange={(e) => handleFileChangeMultipul(e, setlayerMouth, layerMouth)} id="image_taker_mouth_Card" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Dress */}
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">Dress:
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{layerDress?.length}</span>
                                        <span className="text-red-500 text-xl ml-1">*</span>
                                    </label>
                                    <div className="w-full min-h-[60px] max-h-[200px] bg-gray-100 rounded-md p-2 overflow-y-scroll no-scrollbar">
                                        <div className="flex flex-wrap gap-2">
                                            {layerDress?.map((src, idx) => (
                                                <div key={idx} className="relative w-[54px] h-[54px] border-gray-200 rounded-md">
                                                    <Image src={src} alt={`dress-${idx}`} fill className="object-cover rounded-md" />
                                            ...
                                            <input onChange={(e) => handleFileChangeMultipul(e, setlayerDress, layerDress)} id="image_taker_dress_card" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Crown */}
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">Crown:
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{layerCrown?.length}</span>
                                        <span className="text-red-500 text-xl ml-1">*</span>
                                    </label>
                                    <div className="w-full min-h-[60px] max-h-[200px] bg-gray-100 rounded-md p-2 overflow-y-scroll no-scrollbar">
                                        <div className="flex flex-wrap gap-2">
                                            {layerCrown?.map((src, idx) => (
                                                <div key={idx} className="relative w-[54px] h-[54px] border-gray-200 rounded-md">
                                                    <Image src={src} alt={`crown-${idx}`} fill className="object-cover rounded-md" />
                                            ...
                                            <input onChange={(e) => handleFileChangeMultipul(e, setlayerCrown, layerCrown)} id="image_taker_crown_card" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Beard */}
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">Beard:
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{layerBeard?.length}</span>
                                        <span className="text-red-500 text-xl ml-1">*</span>
                                    </label>
                                    <div className="w-full min-h-[60px] max-h-[200px] bg-gray-100 rounded-md p-2 overflow-y-scroll no-scrollbar">
                                        <div className="flex flex-wrap gap-2">
                                            {layerBeard?.map((src, idx) => (
                                                <div key={idx} className="relative w-[54px] h-[54px] border-gray-200 rounded-md">
                                                    <Image src={src} alt={`beard-${idx}`} fill className="object-cover rounded-md" />
                                            ...
                                            <input onChange={(e) => handleFileChangeMultipul(e, setlayerBeard, layerBeard)} id="image_taker_bread_card" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                        </div>
                                    </div>
                                </div>
                            </>
                        ...
                        {productType === 'trading' && (
                            <>
                                {/* Trading Front */}
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">Trading Card Front Base:
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{tredingFrontBase?.length}</span>
                                        <span className="text-red-500 text-xl ml-1">*</span>
                                    </label>
                                    <div className="w-full min-h-[60px] max-h-[200px] bg-gray-100 rounded-md p-2 overflow-y-scroll no-scrollbar">
                                        <div className="flex flex-wrap gap-2">
                                            {tredingFrontBase?.map((src, idx) => (
                                                <div key={idx} className="relative w-[54px] h-[54px] border-gray-200 rounded-md">
                                                    <Image src={src} alt={`front-${idx}`} fill className="object-cover rounded-md" />
                                            ...
                                            <input onChange={(e) => handleFileChangeMultipul(e, settredingFrontBase, tredingFrontBase)} id="image_taker_treding_front_base_card" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Trading Back */}
                                <div className="mt-6">
                                    <label className="block text-gray-700 mb-1">Trading Card Back Base:
                                        <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{tredingBackBase?.length}</span>
                                        <span className="text-red-500 text-xl ml-1">*</span>
                                    </label>
                                    <div className="w-full min-h-[60px] max-h-[200px] bg-gray-100 rounded-md p-2 overflow-y-scroll no-scrollbar">
                                        <div className="flex flex-wrap gap-2">
                                            {tredingBackBase?.map((src, idx) => (
                                                <div key={idx} className="relative w-[54px] h-[54px] border-gray-200 rounded-md">
                                                    <Image src={src} alt={`back-${idx}`} fill className="object-cover rounded-md" />
                                            ...
                                            <input onChange={(e) => handleFileChangeMultipul(e, settredingBackBase, tredingBackBase)} id="image_taker_treding_back_base_card" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                        </div>
                                    </div>
                                </div>
                            </>
                    ...
                    <div className="col-span-1 md:col-span-4">
                        <div className="w-full border border-gray-300 rounded-md px-4 py-3 sticky top-[100px]">
                            ...
                            <div>
                                ...
                                <label htmlFor="thamnail_image">
                                    <div className="w-full h-[180px] bg-gray-100 rounded-md flex items-center justify-center cursor-pointer relative overflow-hidden">
                                        {productThumbnail ? (
                                            <Image src={productThumbnail} alt="Thumbnail" width={1000} height={1000} className="w-full h-full object-cover rounded-md" />
                                        ) : (
                                            <CiCirclePlus className="text-8xl text-gray-300" />
                                        )}
                                    </div>
                                </label>
                                <input onChange={(e) => handleFileChange(e, setproductThumbnail)} id="thamnail_image" type="file" className="hidden" accept="image/png, image/jpeg, image/jpg" />
                            </div>

                            {/* Gallery */}
                            <div className="mt-6">
                                <label className="block text-gray-700 mb-1">Image Gallery:
                                    <span className="px-1 py-0.5 text-sm rounded-md bg-sky-300 text-white ml-1">{productImages?.length}</span>
                                    <span className="text-red-500 text-xl ml-1">*</span>
                                </label>
                                <div className="w-full min-h-[220px] max-h-[300px] bg-gray-100 rounded-md p-2 overflow-y-scroll no-scrollbar">
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        <input onChange={(e) => handleFileChangeMultipul(e, setproductImages, productImages)} id="image_taker" type="file" className="hidden" multiple accept="image/png, image/jpeg, image/jpg" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-start gap-3 mt-6">
                                <button onClick={() => setrander(1)} className="bg-gray-400 text-white px-6 py-2 rounded-lg hover:bg-sky-600 transition cursor-pointer">
                                    Back
                                </button>
                                <button onClick={handleNext} className="bg-sky-400 text-white px-6 py-2 rounded-lg hover:bg-sky-600 transition cursor-pointer flex items-center justify-center gap-2">
            ...
            {activeSlotSelector && (
                <>
                    <div className="fixed inset-0 z-[9998]" onClick={() => setActiveSlotSelector(null)} />
                    <div
                        ...
                        style={{
                            ...
                            bottom: dropdownPos.openUpward ? window.innerHeight - dropdownPos.top : undefined,
                        ...
                        {getAvailableSlots(activeSlotSelector).map(slot => (
                            <div
                                ...
                                onClick={() => {
                                    ...
                                    setTimeout(() => {
                                        document.getElementById(`file_input_${activeSlotSelector}`)?.click();
                                    }, 50);
                                }}
