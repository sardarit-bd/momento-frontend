        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2 max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="space-y-6 text-lg md:text-xl text-slate-600 leading-relaxed font-light">
              <p>Momento began in a pediatric waiting room in New York City.</p>
              <p>
                My newborn son, dressed in a teddy bear suit — a moment that
                felt too iconic to live only in a photo.
              </p>
              <p>
                <strong className="font-semibold text-slate-800">
                  That moment sparked a simple realization:
                </strong>{" "}
                If trading cards can celebrate athletes and celebrities, why not
