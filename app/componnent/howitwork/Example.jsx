      ...
      <section className="relative container mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-shadow cursor-pointer group"
            >
              <div className="w-full h-64 bg-linear-to-br from-slate-200 to-slate-300 rounded-xl mb-4 group-hover:scale-105 transition-transform" />
              <h4 className="font-bold text-slate-900 mb-2">
                Example Deck {i}
              </h4>
              <p className="text-slate-600 text-sm">
                See how this deck came to life
              </p>
            </div>
          ))}
        </div>
