        ...
        <div className="space-y-32">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                Start with the deck that fits your moment. Choose what you want
                to create:
              </p>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-slate-600">
                      {" "}
                      – A full deck featuring custom character cards
                    </span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-slate-600">
                      {" "}
                      – Individual cards with stats and inside jokes
                    </span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-neutral-400 rounded-full flex items-center justify-center shrink-0 mt-1">
                    <span className="text-white text-xs font-bold">✓</span>
                  </div>
                  <div>
                    ...
                    <span className="text-slate-600">
                      {" "}
                      – Premade high-energy add-on deck with wild rules
                    </span>
                  </div>
                </li>
              </ul>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                More than photos — real characters. You don't just upload a
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                Highlight personalities, moments, and inside jokes. Perfect as
                standalone keepsakes or add-ons.
              </p>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-lg">
                  <div className="text-3xl font-black text-pink-500 mb-1">
                    88
                  </div>
                  <div className="text-sm font-bold text-slate-600">
                    Dance Moves
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                See it before it's printed. As you customize, your cards update
                instantly. What you see on screen is exactly what gets printed —
                no guessing.
              </p>
              <Link
                href={"/shop"}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                We handle the rest. Once you're happy, your cards are printed
                with premium card stock, sharp detail, and vibrant color — then
