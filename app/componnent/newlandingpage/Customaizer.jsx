      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-1 gap-12 items-center">
          <div className="order-2 md:order-2 space-y-6 text-center md:text-center">
            <p className="text-2xl font-bold text-gray-700/80 italic mb-8"></p>
            <Link
              href={"/shop"}
          ...
          <div>
            <div className="flex items-center justify-center gap-3 mb-4">
              <button
                ...
                className={`px-2 py-1 rounded-md cursor-pointer ${isDeck ? "bg-sky-400 text-whtie " : "bg-sky-100 text-gray-500"}`}
              >
                Deck Card
              </button>
              <button
