...
const SingleProductSkeleton = () => {
  return (
    <div className="h-fit container my-8 mx-auto border border-gray-200 rounded-lg relative animate-pulse">
      <div className="pb-8 items-center flex justify-between sticky top-17.5 bg-white py-4 px-8 rounded-lg ">
      ...
      <div className="grid bg-white grid-cols-1 md:grid-cols-5 gap-8 px-8 text-gray-700 pb-8 rounded-b-lg">
        <div className="w-full col-span-2">
          <div className="w-full h-75 bg-gray-200 rounded-md"></div>
